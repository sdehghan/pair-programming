       ...
       console.log(this.props)
        ...
        <section>
         <div  onClick={this.clickHandler}>
          {this.state.show? <img src={this.props.data.top1} alt="top-one"/> :null}
         </div>
         <div onClick={this.clickHandler}>
          {this.state.show? <img src={this.props.data.top2} alt="top-two"/> :null}
         </div>
         <div  onClick={this.clickHandler}>
          {this.state.show? <img src={this.props.data.top3} alt="top-three"/> :null}
         </div>
         <div  onClick={this.clickHandler}>
          {this.state.show? <img src={this.props.data.top4} alt="top-four"/> :null}
         </div>
         <div  onClick={this.clickHandler}>
          {this.state.show? <img src={this.props.data.top5} alt="top-five"/> :null}
         </div>
        </section>
        )
    }
